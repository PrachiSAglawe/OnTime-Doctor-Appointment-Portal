...
namespace Web.Areas.ClinicArea.Controllers
{
    [Area("ClinicArea")]
    [ClinicAuth]
    public class OPDSessionHomeController : Controller
    {
        IOPDSession repo;
        IClinic Crepo;
        public OPDSessionHomeController( IOPDSession repo, IClinic Crepo)
        {
            this.repo = repo;
            this.Crepo = Crepo;
        }
        ...
        public async Task<IActionResult> Create(OPDSession rec)
        {
            ViewBag.Clinic = new SelectList(await this.Crepo.GetAll(), "ClinicID", "ClinicName");
        ...
        public async Task<IActionResult> Edit(OPDSession rec)
        {
            ViewBag.Clinic = new SelectList(await this.Crepo.GetAll(), "ClinicID", "ClinicName");
            if (ModelState.IsValid)
            {
